...
void test_intern_orthodox_canonical_form()
{
    std::cout << "wwwwww test_intern_orthodox_canonical_form wwwwww" << std::endl;
    std::cout << "=== orthodox canonical form ===" << std::endl;
    Intern a;
    Intern b(a);
    Intern c;
...
void test_intern_constructor()
{
    std::cout << "wwwwww test_intern_constructor wwwwww" << std::endl;
...
void test_intern_makeform()
{
    std::cout << "wwwwww test_intern_makeform wwwwww" << std::endl;
    std::cout << "=== Shrubbery ===" << std::endl;
    try {
        Intern intern;
        AForm* form = intern.makeForm("Shrubbery Creation Form", "test shrubbery");
        if (form) {
    ...
    try {
        Intern intern;
        AForm* form = intern.makeForm("Robotomy Request Form", "test robotomy");
        if (form) {
            std::cout << *form << std::endl;
            delete form;
        }
    ...
    try {
        Intern intern;
        AForm* form = intern.makeForm("Presidential Pardon Form", "test presidential");
        if (form) {
            std::cout << *form << std::endl;
            delete form;
        }
    ...
    try {
        Intern intern;
        AForm* form = intern.makeForm("Invalid Form", "test invalid");
        if (form) {
            std::cout << *form << std::endl;
            delete form;
        }
...
int main()
{
    ...
    // test Intern
    test_intern_orthodox_canonical_form();
    test_intern_constructor();
